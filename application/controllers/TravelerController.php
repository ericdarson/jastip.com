...
class TravelerController extends CI_Controller
{
	...
	public function index()
	{
			...
			$this->load->view('travelerView/travelerPost.php', $data);
	...
	function add()
	{
      ...
      //           $config['encrypt_name']		= TRUE;
                ...
                // echo $this->input->post('deskripsi');
                    ...
                    $source = './assets/img/traveler/'.$_FILES['poster']['name'];
					...
					$this->Model_Traveler->_insert($data);
